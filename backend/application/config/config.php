...
|
*/
$config['base_url'] = 'http://localhost/sistema_crud_2/backend/';
...
$config['hooks'] = array('post_controller_constructor' => array(
    'class'    => '',
    'function' => 'header',
    'filename' => 'header.php',
    'filepath' => 'hooks'
...
$config['allowed_origins'] = ['http://localhost:8080', 'http://localhost:3000'];
